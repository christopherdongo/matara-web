...
export function Header() {
  ...
  return (
    <header className={`h-16 w-full fixed z-30 ${scrollPosition > 200 ? "bg-white" : "bg-transparent"}`}>
      <nav className="h-auto w-full flex gap-10 flex-row justify-between lg:pl-4 lg:pr-4">
        <a className="w-60 flex justify-center items-center"
        href="#banner"
        >
          <Image
            src={logo_matara}
        ...
        <div className="flex w-12 lg:hidden">
